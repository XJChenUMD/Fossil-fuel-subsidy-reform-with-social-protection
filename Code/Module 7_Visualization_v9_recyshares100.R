...
Data1 %>%  mutate(era = if_else(year <= 2022, "2015–2022", "2023–2030")) %>% ggplot()+
  ...
  scale_alpha_manual(values = c("2015–2022" = 1, "2023–2030" = .75), guide = "none") +
...
ggsave(str_c(pathout5,"/", "Fig2bc_Impact of subsidies removal_exp",".jpg"),
       width = 6,height = 6,dpi = 500)


ggarrange(ggarrange(Fig.2b,Fig.2a_v2, nrow = 1,widths = c(1.8,1),  
                    labels = c("(a)", "(b)"), font.label = list(size = 12, face = "bold")))
ggsave(str_c(pathout5,"/", "Fig2ad_Impact of subsidies removal_exp",".jpg"),
...
ggsave(str_c(pathout5,"/", "Ineq, CO2, and poverty outcome_SP_exp",".jpg"),
       width = 9,height = 6,dpi = 500)
write.csv(Data6, str_c(pathout5,"/", "Ineq, CO2, and poverty outcome_SP_exp",".csv"))
...
ggsave(str_c(pathout5,"/", "Ineq, CO2, and poverty outcome_SP_ImpProd",".jpg"),
       width = 10,height = 7,dpi = 500)
write.csv(Data6, str_c(pathout5,"/", "Ineq, CO2, and poverty outcome_SP_ImpProd",".csv"))
...
ggsave(str_c(pathout5,"/", "Ineq, CO2, and poverty outcome_SP_ImpCons",".jpg"),
       width = 10,height = 7,dpi = 500)
write.csv(Data6, str_c(pathout5,"/", "Ineq, CO2, and poverty outcome_SP_Cons",".csv"))
#===========================
...
ggsave(str_c(pathout5,"/", "Share of benefit_Bottom 50",".jpg"),
       width = 10,height = 7.5,dpi = 500)
write.csv(Data7_min, str_c(pathout5,"/", "Share of benefit_Bottom 50",".csv"))
...
ggsave(str_c(pathout5,"/", "Share of benefit_Bottom 50_v2",".jpg"),
       width = 9,height = 6,dpi = 500)
#===========================
